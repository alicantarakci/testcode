let computers ={
    ...
    // [ ] = aynı objeden birden fazla olabilir
    // {} = sıralama olayı devam ediyor
    ],
    computerAccessuars:[
...
let futbolcu = {
    ArdaGuler:[
        {skills:"85",lane:"solkanat"},
        {age:"17",height:"191cm"},
        {team:"Fenerbahce",color:"YellowBlue"}
    ],
    ArdaTuran:[
        {skills:"83",lane:"ortasaha"},
        {age:"35",height:"189"},
        {team:"Galatasaray",color:"YellowRed"}
    ],

};
futbolcu.ArdaGuler.forEach((sayi, index) => {
    console.log(index + ' => ' + sayi);
});
//obje diyor anlamadım
let oyun = {
    steam:[
        {gamename:"CsGo",howmuch:"100$",disc:"20gb"},
        {gamename:"Rust",howmuch:"10$",disc:"10gb"},
        {gamename:"Ets2",howmuch:"20$",disc:"25gb"},
        {gamename:"Fifa22",howmuch:"200$",disc:"40gb"},       
    ],
    origin:[
        {gamename:"Battlefied",howmuch:"50$",disc:"50gb"},
        {gamename:"battlefied2",howmuch:"60$",disc:"10gb"},
    ]
};
var ü = 1;
while  (ü < 10){
